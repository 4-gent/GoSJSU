      ...
      <div class="profile-container">
        ...
        <div class="profile-banner">
          <div class="profile-avatar-container">
            ...
            <div style="width: 100px; height: 100px; background-color: #0066cc; border-radius: 50%; display: flex; justify-content: center; align-items: center; color: white; font-size: 36px; margin: 0 auto;">
              <%= faculty.getFirstName().charAt(0) %><%= faculty.getLastName().charAt(0) %>
            </div>
          </div>
        </div>
        ...
        <div class="profile-info">
          ...
          <div class="profile-stats">
            <div class="stat-item">
              <h3>Employee ID</h3>
              <p><%= faculty.getEmployeeId() != null ? faculty.getEmployeeId() : "F001" %></p>
            </div>
            <div class="stat-item">
              <h3>Title</h3>
